...
const Faq = tw.div`select-none cursor-pointer border-b-2 hover:border-primary-500 transition-colors duration-300 py-6`;
  ...
  faqsData.map((faq, index) => {
    const renderedFaq = (
      <Faq  key={index} onClick={() => toggleQuestion(index)}>
        ...
        <Answer
          variants={{
            open: { opacity: 1, height: "auto", marginTop: "16px", display: "block",color:'black' },
    ...
    <PrimaryBackgroundContainer style={{paddingTop:'88px',backgroundColor:'white'}}>
      <ContentWithPaddingXl>
        ...
        <FaqsContainer>
          ...
          <FaqsColumn style={{color:'black'}}>{faqCol2}</FaqsColumn>
        </FaqsContainer>
      </ContentWithPaddingXl>
